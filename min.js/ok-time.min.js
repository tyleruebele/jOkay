...
okTime.blur=function(c,b,a){"undefined"===typeof a&&(a=!!b.className.match(/js-ok-time-24/));""!=b.value.replace(/^\s+|\s+$/g,"")&&(b.className=b.className.replace(okTime.errorClass,""),c=okTime(b.value),!1===c?(b.title=okTime.errors[okTime.errno],b.className+=" "+okTime.errorClass):(b.title="",b.value=okTime.format(c,a)))};
